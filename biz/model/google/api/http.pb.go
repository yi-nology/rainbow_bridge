...
type Http struct {
	...
	Rules                        []*HttpRule `protobuf:"bytes,1,rep,name=rules,proto3" form:"rules" json:"rules,omitempty" query:"rules"`
	FullyDecodeReservedExpansion bool        `protobuf:"varint,2,opt,name=fully_decode_reserved_expansion,json=fullyDecodeReservedExpansion,proto3" form:"fully_decode_reserved_expansion" json:"fully_decode_reserved_expansion,omitempty" query:"fully_decode_reserved_expansion"`
}
...
type HttpRule struct {
	...
	Selector string `protobuf:"bytes,1,opt,name=selector,proto3" form:"selector" json:"selector,omitempty" query:"selector"`
	...
	Body               string             `protobuf:"bytes,7,opt,name=body,proto3" form:"body" json:"body,omitempty" query:"body"`
	ResponseBody       string             `protobuf:"bytes,12,opt,name=response_body,json=responseBody,proto3" form:"response_body" json:"response_body,omitempty" query:"response_body"`
	AdditionalBindings []*HttpRule        `protobuf:"bytes,11,rep,name=additional_bindings,json=additionalBindings,proto3" form:"additional_bindings" json:"additional_bindings,omitempty" query:"additional_bindings"`
}
...
var file_google_api_http_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x42, 0x3a, 0x5a, 0x38, 0x67, 0x69, 0x74, 0x68,
	...
	0x62, 0x69, 0x7a, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
