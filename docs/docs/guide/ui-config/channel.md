...
创建渠道前，需要先创建所属的环境。参见 [环境管理](./environment)。
...
A: 使用 [配置迁移](./migration) 功能，可以选择性复制配置到其他渠道。

## 下一步

- [配置管理](./config) - 学习如何创建和管理配置
- [资源管理](./resource) - 了解静态资源的管理
- [配置迁移](./migration) - 在渠道间迁移配置
